  ...
  return (
    <div className="p-4 text-sm text-start leading-relaxed text-muted-foreground">
      <p>
        ...
        commercial, retail, and lifestyle developments. The company currently
        manages over 130,000 square meters of premium multi-use property,
        including beaches, event centres, residential facilities, and office
        spaces.
      </p>
    </div>
  );
